...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0">Mis Expedientes archivados</h4>

            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="javascript: void(0);">Expedientes archivados</a></li>
                    <li class="breadcrumb-item active">Mostrar expedientes archivados</li>
                </ol>
            </div>
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        if (isset($_GET['nombre'])) {
                            ...
                            $query = "SELECT e.IdExp,e.nombre,p.primer_nomb,p.segundo_nomb,p.primer_ape,p.segundo_ape FROM expediente AS e,usuario AS u,perfil AS p,juzgado AS j,aboxex AS ab WHERE e.IdJuz = j.IdJuz AND e.IdExp = ab.IdExp  AND e.IdUser = u.IdUser AND p.IdUser = u.IdUser and e.nombre LIKE '%$busqueda%'  AND e.estado = 'activo' ";
                        ...
                        <?php
                                ...
                                echo "<h5> No se encontro el expediente </h5>";
                            }
                        }
                        ?>
