                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="?controlador=inicio">
                                <i data-feather="home" class="icon-dual"></i> <span data-key="t-widgets">Inicio</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="?controlador=cita">
                                <i data-feather="grid" class="icon-dual"></i> <span data-key="t-widgets">Citas con abogado</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="?controlador=caso">
                                <i data-feather="copy" class="icon-dual"></i> <span data-key="t-widgets">Casos-actuales</span>
                            </a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link menu-link" href="?controlador=tramite">
                                <i data-feather="copy" class="icon-dual"></i> <span data-key="t-widgets">Tramites-actuales</span>
                            </a>
                        </li>


                        <li class="nav-item">
                            <a class="nav-link menu-link" href="?controlador=mostrar-notificacion">
                                <i data-feather="file-text" class="icon-dual"></i> <span data-key="t-widgets">Notificaciones</span>
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="?controlador=mostrar-perfil">
                                <i data-feather="users" class="icon-dual"></i> <span data-key="t-widgets">Perfil</span>
                            </a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link menu-link" href="?controlador=tra-caso-archivado">
                                <i data-feather="layers" class="icon-dual"></i> <span data-key="t-widgets">Expedientes viejos</span>
                            </a>
                        </li>
