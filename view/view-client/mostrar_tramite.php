...
$control = '0';
$queryobe = "SELECT * FROM expediente WHERE iduser='$iduser' and estado='activo' and tipo='tramite'";
...
<?php $control = $expe['nombre']; ?>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card-body">
               <h4>Sucesos importante del tramite.</h4>
                <table class="table table-bordered table-striped">
                   ...
                   // echo "<h5> Aun no hay detalles del expediente </h5>";
                    }
                   ?>
...
<?php
    ...
    echo "<h4>Tu abogado aun no a puesto el tramite.</h4>";
}
