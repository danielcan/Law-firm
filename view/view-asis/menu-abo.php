...
$consultan = "SELECT   perfil.primer_nomb, perfil.primer_ape  FROM perfil, usuario WHERE usuario.IdUser='$iduser' AND usuario.IdUser = perfil.IdUser ";
...
<body>
    ...
    <div id="layout-wrapper">
                                    ...
                                    <ul class="nav nav-sm flex-column">
                                        ...
                                        <li class="nav-item">
                                            ...
                                            <div class="collapse menu-dropdown" id="sidebarProfile">
                                                <ul class="nav nav-sm flex-column">
                                                    <li class="nav-item">
                                                        <a href="?controlador=usuario-create" class="nav-link" data-key="t-simple-page"> Nuevo usuario </a>
                                                    </li>
                                                    <li class="nav-item">
        ...
        <script>
            new FormMask(document.querySelector("#tel"), "(+504) _____-___", "_", ["(", ")", "-"])
            new FormMask(document.querySelector("#cel"), "(+504) _____-___", "_", ["(", ")", "-"])
            new FormMask(document.querySelector("#DNI"), "____-____-_____", "_", ["(", ")", "-"])
