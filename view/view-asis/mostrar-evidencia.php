        ...
        <div class="card">
            <div class="card-header">
                <h4>Evidencia del caso
                    ...
                    <a href="menu-abo.php?controlador=evidencia-create&idexp=<?= $exp_id; ?>"
                        class="btn btn-primary float-end">Agregar nueva evidencia al expediente</a>
                </h4>

                <form action="code-evidencia.php" method="POST" class="d-inline">
                    <div class="position-relative">
                        <input type="hidden" name="exp_id" value="<?= $exp_id; ?>">
                        <input type="text" name="busqueda_ev" class="form-control" placeholder="Buscar evidencia..."
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        <?php
                            ...
                            $query = "SELECT * FROM evidencia WHERE IdExp='$exp_id' and estado='activo'";
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="menu-abo.php?controlador=evidencia-edit&idevi=<?= $deta['IdEvid']; ?>"
                                    class="btn btn-success btn-sm">Editar</a>
                                <form action="code-evidencia.php" method="POST" class="d-inline">
                                    <button type="submit" name="delete_evi" value="<?= $deta['IdEvid']; ?>"
                        ...
                        <?php
                                ...
                                echo "<h5> Aun no hay evidencia en este expediente. </h5>";
                            }
