        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        <?php
                        $query = "SELECT e.IdExp,e.nombre,p.primer_nomb,p.segundo_nomb,p.primer_ape,p.segundo_ape,e.tipo FROM expediente AS e,usuario AS u,perfil AS p,juzgado AS j,aboxex AS ab WHERE ab.IdAbo = $idabog And e.IdJuz = j.IdJuz AND e.IdExp = ab.IdExp  AND e.IdUser = u.IdUser AND p.IdUser = u.IdUser AND e.estado='activo'";
