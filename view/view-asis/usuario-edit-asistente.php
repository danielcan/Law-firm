  ...
  <div class="row">
      <div class="col-12">
          <div class="page-title-box d-sm-flex align-items-center justify-content-between">
              <h4 class="mb-sm-0">Editar usuario asistente</h4>

              <div class="page-title-right">
                  <ol class="breadcrumb m-0">
                      <li class="breadcrumb-item"><a href="javascript: void(0);">Asistente</a></li>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Editar usuario
                            <a href="menu-abo.php?controlador=mostrar-user-asistente" class="btn btn-danger float-end">Regresar</a>
                        </h4>
                    </div>
                    <div class="card-body">
                        ...
                        if(isset($_GET['id']))
                        {
                            ...
                            if(mysqli_num_rows($query_run) > 0)
                            {
                                ...
                                ?>
                                <form action="codeuser-asistente.php" method="POST">
