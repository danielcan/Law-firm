                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        if (isset($_GET['nombre'])) {
                            ...
                            $query = "SELECT e.IdExp,e.nombre,p.primer_nomb,p.segundo_nomb,p.primer_ape,p.segundo_ape FROM expediente AS e,usuario AS u,perfil AS p,juzgado AS j,aboxex AS ab WHERE ab.IdAbo = $idabog AND e.IdJuz = j.IdJuz AND e.IdExp = ab.IdExp  AND e.IdUser = u.IdUser AND p.IdUser = u.IdUser and e.nombre LIKE '%$busqueda%'  AND e.estado = 'finalizado' ";
