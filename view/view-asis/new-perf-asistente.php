...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0">Creación de nuevo asistente legal</h4>

            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="javascript: void(0);">Asistente legal dentro del sistema</a></li>
                    <li class="breadcrumb-item active">perfil de asistente</li>
                </ol>
            </div>
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header align-items-center d-flex">
                <h4 class="card-title mb-0 flex-grow-1">Agrega el perfil del asistente</h4>
                <div class="flex-shrink-0">

                </div>
            </div><!-- end card header -->
            <form action="codeperfil-asistente.php" method="post">
                <div class="card-body">
                    <div class="live-preview">
                        <div class="row gy-4">
                            ...
                            <div class="col-xxl-3 col-md-6">
                                <div>
                                    <label for="valueInput" class="form-label">Número Identidad</label>
                            ...
                            <div class="col-xxl-3 col-md-6">
                                <div>
                                    <button type="submit" name="save_perfil" class="btn btn-primary">Agregar perfil asistente</button>
                                </div>
                            </div>
