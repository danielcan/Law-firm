            ...
            <div class="card">
                <div class="card-header">
                    <h4>Documentos del expediente
                        ...
                        <a href="menu-abo.php?controlador=documento-create&idexp=<?= $exp_id; ?>" class="btn btn-primary float-end">Agregar nuevo documento al expediente</a>
                    </h4>
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            if (isset($_GET['nombre'])) {
                                ...
                                $query = "SELECT * FROM documento WHERE nombre LIKE '%$busqueda%' AND IdExp='$exp_id' AND estado = 'activo'";
                            ...
                            ?>
                                        ...
                                        <tr>
                                            <td><?= $deta['nombre']; ?></td>
                                            <td><a href="../../<?= $deta['documento']; ?>" target="_blank">Ver documento</td>
                                            <td>
                                                <a href="menu-abo.php?controlador=documento-edit&iddoc=<?= $deta['IdDoc']; ?>" class="btn btn-success btn-sm">Editar</a>
                                                <form action="code-documento.php" method="POST" class="d-inline">
                                                    <button type="submit" name="delete_doc" value="<?= $deta['IdDoc']; ?>" class="btn btn-danger btn-sm">Eliminar</button>
                                                </form>
                                            </td>
