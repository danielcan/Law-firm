		...
		$('#calendar').fullCalendar({
			...
			events: [
				...
				?> {
						...
						descripcion: '<?php echo $registros_eventos['descripcion']; ?>',
					},
				<?php
				}
				?>
						...
						<div class="modal-body">
							<form class="form-horizontal" method="POST" action="proceso.php">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="datetime-local" class="form-control" name="inicio" id="start" onKeyPress="DataHora(event, this)">
									</div>
								</div>
								<div class="form-group">
									<label for="inputEmail3" class="col-sm-2 control-label">Data Final</label>
									<div class="col-sm-10">
										<input type="datetime-local" class="form-control" name="fin" id="end" onKeyPress="DataHora(event, this)">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="" class="form-control" name="descripcion" id="descripcion">
									</div>
								</div>
