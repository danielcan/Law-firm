                     ...
                     <form action="codeconfig.php" method="post">
                         ...
                         <div class="col-xxl-3 col-md-7">
                                 <div>
                                     ...
                                     <input type="text" name="nombreConfig" class="form-control" id="basiInput" required="required">
                                 </div>
                             </div>
                             ...
                             <div class="col-xxl-3 col-md-7">
                                 <div>
                                     <select name="iduserab" size="1" id="Esp" class="form-control" for="basiInput" required="required">
