                ...
                <div class="card-header">
                    ...
                    <form action="coderecibo.php" method="POST" class="d-inline">
                        <div class="position-relative">
                            <input type="text" name="busqueda_r" class="form-control" placeholder="Buscar recibo..." autocomplete="off" id="search-options" value="" style=" float: left; width : 250px; ">
                ...
                <div class="card-body">
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            $query = "SELECT * FROM recibo WHERE IdAbo = '$idabog' order by IdRec DESC";
                            ...
                            <?php
                                ...
                                echo "<h5> Aun no hay documentos. </h5>";
                            }
