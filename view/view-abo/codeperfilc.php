...
if(isset($_POST['update_perfil']))
{
    ...
    if($query_run)
    {
        ...
        //Datos de bitacora
        $actividad = "Actualización del perfil abogado";
        $tabla="perfil";
        ...
        print("<script>alert(\"Se actualizo exitosamente el perfil. \"); window.location.href='menu-abo.php?controlador=mostrar-perfil';</script>");
        exit(0);
    }
    else
    {
        print("<script>alert(\"No se pudo actualizar el perfil, verifica la información proporcionada. \"); window.location.href='menu-abo.php?controlador=mostrar-perfil';</script>");
        exit(0);
    }
