            ...
            <div class="d-flex align-items-center">
                        ...
                        <div class="tab-content" id="notificationItemsTabContent">
                            <div class="tab-pane fade show active py-2 ps-2" id="all-noti-tab" role="tabpanel">
                                <div data-simplebar style="max-height: 300px;" class="pe-2">
                                    <?php
                                    $querynomb = "SELECT * FROM notificacion where estado='no leido' and IdUser = '$iduser' ORDER BY IdNoti DESC";
                                                ...
                                                <div class="d-flex">
                                                    ...
                                                    <div class="flex-1">
                                                        ...
                                                        <p class="mb-0 fs-11 fw-medium text-uppercase text-muted">
                                                            <span><i class="mdi mdi-clock-outline"></i><?= $nomb['fecha_noti']; ?></span>
                                                        </p>
                                                    </div>
                                    ...
                                    <div class="my-3 text-center">
                                        <a type="button" class="btn btn-soft-success waves-effect waves-light" href="menu-abo.php?controlador=mostrar-noti">
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a class="dropdown-item" href="menu-abo.php?controlador=mostrar-perfil"><i class="mdi mdi-account-circle text-muted fs-16 align-middle me-1"></i>
